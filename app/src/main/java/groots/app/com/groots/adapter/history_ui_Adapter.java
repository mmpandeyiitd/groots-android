...
public class history_ui_Adapter extends RecyclerView.Adapter<history_ui_Adapter.CartHolder> {
    ...
    public history_ui_Adapter(ArrayList<CartClass> cartClasses, Context context, UpdateCart updateCart) {
    ...
    @Override
    public history_ui_Adapter.CartHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_update_order, parent, false);
        history_ui_Adapter.CartHolder dataObjectHolder = new history_ui_Adapter.CartHolder(view);
        return dataObjectHolder;
    }


    @Override
    public void onBindViewHolder(final history_ui_Adapter.CartHolder holder, final int position) {
